                    ...
                    <div class="border rounded shadow mb-3">
                        <div class="row bg-white">
                            ...
                            <div class="col-md-3 py-5">
                                <div>
                                    <input type="number" min="1" max="<?php mysqli_query($con, "SELECT inventory.num_stocks FROM cart, inventory WHERE cart.cp_id = inventory.id;") or die('query failed');?>" name="update_quantity" value="<?php echo $result['cp_qty']; ?>" class="form-control w-50 d-inline"> Kilo/s <br>
